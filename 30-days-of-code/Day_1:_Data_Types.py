...
# declared and initialized for you. You must declare
# variables: one of type int, one of type double, and one of type String.
# Then you must read 3 lines of input from stdin and initialize
# your variables. Finally, you must use the + operator to perform the following
# operations:

# Print the sum of i plus your int variable on a new line.
# Print the sum of d plus your double variable to a scale of one decimal place
# on a new line.
# Concatenate s with the string you read as input and print the result on a
# new line.
# Note: If you are using a language that doesn't support using + for string
# concatenation (e.g.: C), you can just print one variable
# immediately following the other on the same line. The string provided in
# your editor must be printed first, immediately followed by the
...
# (scaled to 1 decimal place) on the second line, and then the
