...
# with this series. You will need to use the same (or similar)
# syntax to read input and write output in challenges throughout HackerRank.
...
# variable, print Hello, World. on a single line, and finally
# print the value of your variable on a second line.

# You've got this!

# Note: The instructions are Java-based, but we support submissions in many
# popular languages. You can switch languages using the
# drop-down menu above your editor, and the inputString variable may be written
# differently depending on the best-practice conventions
