...
The types of queries that can be performed on your list of sequences (seqList)
# are described below:
1] Query: 1 . y
...
2] Query: 2 . y
    1] Find the sequence, seq, at index ((x xor lastAns) % N) in seqList.
    2] Find the value of element y % size in seq (where size is the size of
    seq) and assign it to lastAns.
